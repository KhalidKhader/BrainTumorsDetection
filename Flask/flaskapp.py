...
model = tf.keras.models.load_model('/Users/khader/Desktop/brainTumors/test/model11.h5')
...
def predict():
    ...
    file_path = '/Users/khader/Desktop/brainTumors/test/test/all/'+file.filename
    file.save(file_path)
